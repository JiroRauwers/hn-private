...
import { type CreateServerInput, createServerSchema } from "@/lib/types/server";
		...
		startTransition(async () => {
			try {
				...
				toast({
					...
					description:
						"Your server has been submitted for review. We'll notify you once it's approved.",
				});
		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Submit your server for approval on the platform
				</p>
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Fill in the details about your server. All fields marked with * are
						required.
					</CardDescription>
				</CardHeader>
				<CardContent>
